...
export class SupplierService {
  ...
  private _suppliersWithSwitchMap$ = of(1, 5, 8).pipe(
    tap((id) => console.log('switchMap source Observable', id)),
    switchMap((id) => this.http.get<Supplier>(`${this.suppliersUrl}/${id}`))
  );
  public get suppliersWithSwitchMap$() {
    return this._suppliersWithSwitchMap$;
  }
  public set suppliersWithSwitchMap$(value) {
    this._suppliersWithSwitchMap$ = value;
  }
